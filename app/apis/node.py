...
def upload_files_default(body: UploadFile, db: Session = Depends(database.get_session)):
    pass


@router.post("/{space_id}/nodes/files")
def upload_files(
    space_id: UUID, body: UploadFile, db: Session = Depends(database.get_session)
):
    pass
...
@router.post("/{space_id}/nodes/files")
def create_folder(
    space_id: UUID, body: CreateFolder, db: Session = Depends(database.get_session)
):
    pass
...
def list_space_nodes_default(
    query: ListSpaceNodes, db: Session = Depends(database.get_session)
):
    pass
...
def list_space_nodes(
    space_id: UUID, query: ListSpaceNodes, db: Session = Depends(database.get_session)
):
    pass
...
def list_folder_nodes_default(
    node_id: int, query: ListFolderNodes, db: Session = Depends(database.get_session)
):
    pass
...
def rename_node_default(node_id: int, db: Session = Depends(database.get_session)):
    pass
...
def copy_node_default(
    node_id: int, body: CopyNode, db: Session = Depends(database.get_session)
):
    pass
...
def move_node_default(
    node_id: int, body: MoveNode, db: Session = Depends(database.get_session)
):
    pass
...
def archive_node_default(node_id: int, db: Session = Depends(database.get_session)):
    pass
...
def delete_node_default(
    node_id: int, query: DeleteNode, db: Session = Depends(database.get_session)
):
    pass
